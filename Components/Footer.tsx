...
const Footer = () => {
  return (
    <div id='contact' className='pt-[8rem] pb-[4rem] bg-[#000022]'>
        <div className='grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[80%] mx-auto gap-[3rem]'>
            <div className='flex items-center space-x-6'>
                ...
                <div>
                    ...
                    <p className='text-[17px] w-[90%] text-white opacity-60'>Buon Ma Thuot City</p>
                </div>
            </div>
            ...
            <div className='flex items-center space-x-6'>
                ...
                <div>
                    ...
                    <p className='text-[17px] w-[90%] text-white opacity-60'>0332063427</p>
                </div>
            </div>
            ...
            <div className='flex items-center space-x-6'>
                ...
                <div>
                    ...
                    <p className='text-[17px] w-[90%] text-white opacity-60'>buiphuong130503@gmail.com</p>
                </div>
            </div>
        </div>
        ...
        <div className='w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between'>
            <div className='text-[16px] mb-[2rem] md:mb-0 text-white opacity-20'>
                Webdev DuyPhuong 2024 | All Rights Reserved
            </div>
